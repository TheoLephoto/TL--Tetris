      'use strict';
        ...
        //  x value of 1 (indicating movement towards the right on the x-axis)
        // y value of 0 (no movement on the y-axis).
        var right = { x: 1, y: 0 };

        // x value of 0 (no movement on the x-axis) and a y value of 1 (indicating movement downwards on the y-axis).
        var down = { x: 0, y: 1 };

        // x value of -1 (indicating movement towards the left on the x-axis) and a y value of 0 (no movement on the y-axis).
        var left = { x: -1, y: 0 };
